...
public class Iris_Skill2 : MonoBehaviour {
    ...
    public void Start_FenFire(Vector3 myPosition, int pNum)
    {
        ...
        moveLength = createPosition.x;

        fenFire_Temp = Instantiate(fenFire[isFenFire], transform.position, Quaternion.identity);
        ...
        bulletIrisSkill2.StartMoveFenFire(pNum, isFenFire, myPosition, moveLength);
